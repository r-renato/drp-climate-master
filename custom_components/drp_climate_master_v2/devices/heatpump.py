...
class HeatPumpDevice(Protocol):
    ...
    async def set_power(self, *, fm_power: Optional[bool] = None, power: Optional[bool] = None) -> None: ...
    async def set_processing_mode(self, mode: str) -> None: ...
    async def set_heat_setpoints(self, *, t: Optional[float] = None, dt: Optional[float] = None) -> None: ...
    async def set_cool_setpoints(self, *, t: Optional[float] = None, dt: Optional[float] = None) -> None: ...
